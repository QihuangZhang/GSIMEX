# This files stem from the GSIMEX-ZIP file with averaging considered within the same value on the training
...
data_generation_LavgM <- function(SIM_id, beta, Mis_mtr, sd_error){
   # Data Generation
  set.seed(SIM_id)
  
  Covarmain1 <- data.frame(X1 = runif(nsample,-1,2), X2 = rbinom(nsample,1,0.5))
...
SIMEX_LavgM <- function(SimData, sd_error, Mis_mtr,  maxq = 6, zeta_m = 2, B = 500, M = 20,  nfold = 10, CVstep = 2, CVmfold = 3){   # ** I added an M
  coefs_Z <- NULL
...
# Sim_LavgM_1 <- function(SIM_id, beta1, beta2, Mis_mtr, sd_error, zeta_m = 2, B = 4000){
#   # Data Generation
#   set.seed(SIM_id)
# 
...
Sim_LavgM_CV <- function(SIM_id, beta, Mis_mtr, sd_error, maxq = 6, zeta_m = 2, B = 500, M = 20,  nfold = 20, CVstep = 10, CVmfold = 3){
  # Data Generation
  set.seed(SIM_id)
...
Sim_LavgM_CV_MEonly <- function(SIM_id, beta, Mis_mtr, sd_error, maxq = 6, zeta_m = 2, B = 400, M = 30,  nfold = 20, CVstep = 10, CVmfold = 3){
  ...
  # Naive method
  coef_orc <- lm( Y ~ X1star + X2,data = SimData)$coef
...
# 
# 
#   result <- Sim_LavgM_1(SIM_id = seed_i[var1],
#             beta1 = beta1true,
#             beta2 = beta2true,
#             Mis_mtr = matrix(c(0.7,0.3,0.2,0.8), nrow = 2, byrow = T),
#             sd_error = 1,
...
# stopCluster(cl)
# 
# save(Simulation1, file=paste0("output/Simulation/GIMEX-LavgM-Sim1.1.2.RData"))
# 
# load(file=paste0("output/Simulation/GIMEX-LavgM-Sim1.1.2.RData"))
# 
# # str(Simulation1)
# 
...
# 
# pdf("output/Simulation/GIMEX-LavgM-Sim1.1.2.pdf", width = 12, height = 6)
# 
...
# stopCluster(cl)
# 
# save(Simulation1.1.3, file=paste0("output/Simulation/GIMEX-LavgM-Sim1.1.3.RData"))
# 
# load(file=paste0("output/Simulation/GIMEX-LavgM-Sim1.1.3.RData"))
# 
# # str(Simulation1)
# 
...
# 
# 
# pdf("output/Simulation/GIMEX-LavgM-Sim1.1.3.pdf", width = 12, height = 6)
# 
...
# 
# 
# # cl <- makeCluster(ncores, outfile=paste0("GSIMEX_LavgM_3.1.1.5", range_eval[1], "-", range_eval[2],".txt"))
# # registerDoParallel(cl)
# # 
# betatrue <- c(-0.5, 0.5)
# # 
...
# # 
# # 
# #   result <- Sim_LavgM_CV(SIM_id = seed_i[var1],
# #                       beta = betatrue,
...
# # stopCluster(cl)
# # 
# # save(Simulation1.1.5, file=paste0("output/Simulation/GIMEX-LavgM-Sim1.1.5", range_eval[1], "-", range_eval[2],".RData"))
# # 
# # 
# # List files matching the specified pattern
# matching_files <- list.files(path = "output/Simulation", pattern = "GIMEX-LavgM-Sim1.1.5.*\\.RData$", full.names = TRUE)
# 
...
# 
# # # Summarize the
# pdf("output/Simulation/GIMEX-LavgM-Sim1.1.5.pdf", width = 14, height = 11)
# 
...
# # 
# # 
# # pdf("output/Simulation/GIMEX-LavgM-Sim1.1.5_distribution.pdf", width = 14, height = 11)
# # 
# # # Sim1_BS_all$modelm <- factor(Sim1_BS_all$modelm)
# # # Sim1_BS_all$model_id <- factor(Sim1_BS_all$model_id, levels = c(1:64, paste("best of", 1:6), "CV optimal m"))
# # 
...
# 
# 
# cl <- makeCluster(ncores, outfile=paste0("GSIMEX_LavgM_3.1.1.6", range_eval[1], "-", range_eval[2],".txt"))
# registerDoParallel(cl)
# 
# betatrue <- c(-0.5, 0.5)
# 
...
# stopCluster(cl)
# 
# save(Simulation1.1.6, file=paste0("output/Simulation/GIMEX-LavgM-Sim1.1.6", range_eval[1], "-", range_eval[2],".RData"))
# 
# 
# # List files matching the specified pattern
# matching_files <- list.files(path = "output/Simulation", pattern = "GIMEX-LavgM-Sim1.1.6.*\\.RData$", full.names = TRUE)
# 
...
# 
# # # Summarize the
# pdf("output/Simulation/GIMEX-LavgM-Sim1.1.6.pdf", width = 14, height = 11)
# 
# # Sim1_BS_all$modelm <- factor(Sim1_BS_all$modelm)
# # Sim1_BS_all$model_id <- factor(Sim1_BS_all$model_id, levels = c(1:64, paste("best of", 1:6), "CV optimal m"))
# 
...
# 
# 
# pdf("output/Simulation/GIMEX-LavgM-Sim1.1.6_distribution.pdf", width = 14, height = 11)
# 
# # Sim1_BS_all$modelm <- factor(Sim1_BS_all$modelm)
# # Sim1_BS_all$model_id <- factor(Sim1_BS_all$model_id, levels = c(1:64, paste("best of", 1:6), "CV optimal m"))
# 
...
cl <- makeCluster(ncores, outfile=paste0("GSIMEX_LavgM_3.1.1.7", range_eval[1], "-", range_eval[2],".txt"))
registerDoParallel(cl)
...
save(Simulation1.1.7, file=paste0("output/Simulation/GIMEX-LavgM-Sim1.1.7", range_eval[1], "-", range_eval[2],".RData"))
...
pdf("output/Simulation/GIMEX-LavgM-Sim1.1.7.pdf", width = 14, height = 11)
...
#   
#   
#   result <- Sim_LavgM_unit(SIM_id = seed_i[var1], 
#                       beta1 = beta1true, 
#                       beta2 = beta2true, 
#                       Mis_mtr = matrix(c(0.7,0.3,0.2,0.8), nrow = 2, byrow = T), 
#                       sd_error = 1)
...
# stopCluster(cl)
# 
# save(Simulation1.2, file=paste0("output/Simulation/GIMEX-LavgM-Sim1.2_Unit.RData"))
# 
# load(file=paste0("output/Simulation/GIMEX-LavgM-Sim1.2_Unit.RData"))
# 
# # str(Simulation1)
# 
...
#   mutate(bias = abs(betahat  - truth))
# 
# pdf("output/Simulation/GIMEX-LavgM-Sim1.2_Unit.pdf", width = 12, height = 6)
# 
# Sim1_summary$order <- factor(Sim1_summary$order)
# Sim1_summary$model_id <- factor(Sim1_summary$model_id)
# 
...
# stopCluster(cl)
# 
# save(Simulation1.2.1, file=paste0("output/Simulation/GIMEX-LavgM-Sim1.2_Unit.RData"))
# 
# load(file=paste0("output/Simulation/GIMEX-LavgM-Sim1.2_Unit.RData"))
# 
# # str(Simulation1)
...
#   mutate(bias = abs(betahat  - truth))
# 
# pdf("output/Simulation/GIMEX-LavgM-Sim1.2.1.pdf", width = 12, height = 6)
# 
# Sim1_summary$order <- factor(Sim1_summary$order)
# Sim1_summary$model_id <- factor(Sim1_summary$model_id)
# 
